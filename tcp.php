...
$server = new SocketServer("172.31.23.210",3000); // Create a Server binding to the given ip address and listen to port 31337 for connections
$server->max_clients = 88; // Allow no more than 10 people to connect at a time
